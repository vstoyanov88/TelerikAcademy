...
class MissCat2011
{
    static void Main()
    {
        ...
        else if (cat7 >= cat1 && cat7 >= cat2 && cat7 >= cat3 && cat7 >= cat4 && cat7 >= cat5 && cat7 >= cat6 && cat7 >= cat8 && cat7 >= cat9 && cat7 >= 10)
        {
            Console.WriteLine(7);
        }
        else if (cat8 >= cat1 && cat8 >= cat2 && cat8 >= cat3 && cat8 >= cat4 && cat8 >= cat5 && cat8 >= cat6 && cat8 >= cat7 && cat8 >= cat9 && cat8 >= 10)
        {
            Console.WriteLine(8);
        }
        else if (cat9 >= cat1 && cat9 >= cat2 && cat9 >= cat3 && cat9 >= cat4 && cat9 >= cat5 && cat9 >= cat6 && cat9 >= cat7 && cat9 >= cat8 && cat9 >= 10)
        {
            Console.WriteLine(9);
        }
        else if (cat10 >= cat1 && cat10 >= cat2 && cat10 >= cat3 && cat10 >= cat4 && cat10 >= cat5 && cat10 >= cat6 && cat10 >= cat7 && cat10 >= cat8 && cat10 >= 9)
        {
